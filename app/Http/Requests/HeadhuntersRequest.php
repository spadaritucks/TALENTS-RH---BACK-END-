...
class HeadhuntersRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'comportamento_description' => 'required|string|max:1000',
            'anos_trabalho' => 'required|string',
            'quantia_vagas' => 'required|string',
            'horas_diarias' => 'required|string',
            'dias_semanais' => 'required|string',
